...
@RestController
@RequestMapping("/api/drama-kafka")
public class DramaKafkaResource {

    private final Logger log = LoggerFactory.getLogger(DramaKafkaResource.class);

    private final KafkaProperties kafkaProperties;
    private KafkaProducer<String, String> producer;
    private ExecutorService sseExecutorService = Executors.newCachedThreadPool();

    public DramaKafkaResource(KafkaProperties kafkaProperties) {
